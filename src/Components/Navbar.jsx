...
function Navbar() {
  return (
    <div className='w-full flex h-full max-h-[3rem] bg-blue-200 rounded-full drop-shadow-md items-center px-2 justify-between'>
      <Link to='/'>
      <div className='size-8 bg-yellow-400 text-white rounded-full p-1'>
        ...
        <Link to='/profile'>
        <div className='size-8 bg-green-400 text-white rounded-full p-1'>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-full h-full">
